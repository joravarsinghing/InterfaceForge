...
async def test_cache_invalidation_after_model_change():
    ...
    res1 = await provider.export_format("cache_test_proj", 1, "stl", "kcl_code_1", project=p1)
    ...
    res2 = await provider.export_format("cache_test_proj", 2, "stl", "kcl_code_2", project=p2)
